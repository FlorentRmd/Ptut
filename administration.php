...
<div class="tab-content">
    <div id="organi" class="container tab-pane active"><br>
        <h3>ORGANIGRAMME</h3>
        <img class="rounded mx-auto d-block" src="Img/Organi.jpg"><br>
    ...
    <div id="Hentr" class="container tab-pane fade"><br>
        ...
        <img src="Img/horaire-entrainement.png" style="width: 90%"><br>
        <p><a href="Img/Planning-V8-ENTRAINEMENT-AUC13VB-2019-20.pdf" title="Pdf">     Télécharger le en pdf</a></p><br>
    ...
    <div id="gymnase" class="container tab-pane fade"><br>
        ...
        <img  class="rounded mx-auto d-block" src="Img/gymnase.jpg"><br>
